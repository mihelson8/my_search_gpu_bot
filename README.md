...
1. Скриншоты окна **Seetong PC Client** (окно не сворачивайте).
...
3. Распознавание российских номеров (тип 1: `А123ВС 777`).
...
1. Откройте **Seetong** и выведите картинку камеры на въезд.
2. Двойной клик по **`START_ANPR.bat`** (при первом запуске поставит OpenCV, mss, RapidOCR).
3. В программе нажмите **Старт**. Источник по умолчанию — «Окно Seetong».
