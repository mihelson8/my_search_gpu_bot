...
4. **🤖 Интерактивный Telegram-бот:**
   - 🔤 **Кнопки языков в главном меню:** `[🇷🇺 Русский]`, `[🇺🇸 American English]`, `[🇨🇳 Путунхуа]`, `[🇭🇰 Кантонский / Байхуа]`.
   - 🎙 **Голосовой и текстовый ввод:** пишите или наговаривайте голосом фразу на любом из этих языков и диалектов.
   - 📖 **Синхронный перевод на все языки:** бот показывает текст на русском, путунхуа (с пиньинем), кантонском (байхуа) и американском английском (US).
