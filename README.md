...
4. **🤖 Интерактивный Telegram-бот:**
   - 🎙 **Голосовой перевод (Voice Input):** отправляйте голосовые сообщения на русском, английском, путунхуа или кантонском (байхуа) — бот распознает речь и мгновенно переведет термин!
   - 🔊 **Озвучка произношения (TTS):** кнопки «🔊 Путунхуа (Mandarin)», «🔊 Байхуа / Кантонский» и «🔊 Озвучить (English)» для прослушивания точного произношения на разных диалектах.
   - 🔍 Быстрый поиск при отправке любого текстового сообщения.
