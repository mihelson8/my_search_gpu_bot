...
4. **🤖 Интерактивный Telegram-бот:**
   ...
   - 🔊 **Озвучка произношения (TTS):** кнопки «🔊 Путунхуа (Mandarin)», «🔊 Байхуа (Cantonese)», «🔊 Озвучить (Русский)» и «🔊 Озвучить (English)» для прослушивания точного произношения на всех языках и диалектах.
